...
public enum Merit {
    ...
    //Bloodline merits
    ASSAMITE(DistinctionType.BLOODLINE, Clan.ASSAMITE, Bloodline.NONE, 0),
    ...
    BRUJAH(DistinctionType.BLOODLINE, Clan.BRUJAH, Bloodline.NONE, 0),
    TRUE_BRUJAH(DistinctionType.BLOODLINE, Clan.BRUJAH, Bloodline.TRUE_BRUJAH, 4),
    FOLLOWER_OF_SET(DistinctionType.BLOODLINE, Clan.FOLLOWER_OF_SET, Bloodline.NONE, 0),
    ...
    GANGREL(DistinctionType.BLOODLINE, Clan.GANGREL, Bloodline.NONE, 0),
    ...
    GIOVANNI(DistinctionType.BLOODLINE, Clan.GIOVANNI, Bloodline.NONE, 0),
    PREMASCINE(DistinctionType.BLOODLINE, Clan.GIOVANNI, Bloodline.PREMASCINE, 4),
    LASOMBRA(DistinctionType.BLOODLINE, Clan.LASOMBRA, Bloodline.NONE, 0),
    KISAYD(DistinctionType.BLOODLINE, Clan.LASOMBRA, Bloodline.KISAYD, 4),
    MALKAVIAN(DistinctionType.BLOODLINE, Clan.MALKAVIAN, Bloodline.NONE, 0),
    ...
    NOSFERATU(DistinctionType.BLOODLINE, Clan.NOSFERATU, Bloodline.NONE, 0),
    TOREADOR(DistinctionType.BLOODLINE, Clan.TOREADOR, Bloodline.NONE, 0),
    ...
    TREMERE(DistinctionType.BLOODLINE, Clan.TREMERE, Bloodline.NONE, 0),
    TELYAV(DistinctionType.BLOODLINE, Clan.TREMERE, Bloodline.TELYAV, 2),
    TZIMISCE(DistinctionType.BLOODLINE, Clan.TZIMISCE, Bloodline.NONE, 0),
    ...
    VENTRUE(DistinctionType.BLOODLINE, Clan.VENTRUE, Bloodline.NONE, 0),
    CRUSADER(DistinctionType.BLOODLINE, Clan.VENTRUE, Bloodline.CRUSADER, 2),
    CATIFF(DistinctionType.BLOODLINE, Clan.CATIFF, Bloodline.NONE, 0),
    BAALI(DistinctionType.BLOODLINE, Clan.BAALI, Bloodline.NONE, 0),
    ANGELLIS_ATER(DistinctionType.BLOODLINE, Clan.BAALI, Bloodline.ANGELLIS_ATER, 3),
    CAPPADOCIAN(DistinctionType.BLOODLINE, Clan.CAPPADOCIAN, Bloodline.NONE, 0),
    SAMEDI(DistinctionType.BLOODLINE, Clan.CAPPADOCIAN, Bloodline.SAMEDI, 2),
    LAMIA(DistinctionType.BLOODLINE, Clan.CAPPADOCIAN, Bloodline.LAMIA, 3),
    RAVNOS(DistinctionType.BLOODLINE, Clan.RAVNOS, Bloodline.NONE, 0),
    BRAHMAN(DistinctionType.BLOODLINE, Clan.RAVNOS, Bloodline.BRAHMAN, 2),
    SALUBRI(DistinctionType.BLOODLINE, Clan.SALUBRI, Bloodline.NONE, 0),
    HEALER(DistinctionType.BLOODLINE, Clan.SALUBRI, Bloodline.HEALER, 3),
    DAUGHTER_OF_CACOPHONY(DistinctionType.BLOODLINE, Clan.DAUGHTER_OF_CACOPHONY, Bloodline.NONE, 0),
    GARGOYLE(DistinctionType.BLOODLINE, Clan.GARGOYLE, Bloodline.NONE, 0),
