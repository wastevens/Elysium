...
alter table MentalAttribute_focuses drop foreign key FK_1ecc9atlai94qdk8jbd5ioeyg;
alter table PhysicalAttribute_focuses drop foreign key FK_7a959c0ouasro88p7riagjheh;
...
drop table if exists MentalAttribute_focuses;
drop table if exists PhysicalAttribute;
drop table if exists PhysicalAttribute_focuses;
...
drop table if exists SocialAttribute_focuses;
...
create table MentalAttribute_focuses (MentalAttribute_character_id varchar(255) not null, focuses integer);
create table PhysicalAttribute (character_id varchar(255) not null, rating integer, primary key (character_id));
create table PhysicalAttribute_focuses (PhysicalAttribute_character_id varchar(255) not null, focuses integer);
...
alter table MentalAttribute_focuses add constraint FK_1ecc9atlai94qdk8jbd5ioeyg foreign key (MentalAttribute_character_id) references MentalAttribute (character_id);
alter table PhysicalAttribute_focuses add constraint FK_7a959c0ouasro88p7riagjheh foreign key (PhysicalAttribute_character_id) references PhysicalAttribute (character_id);
