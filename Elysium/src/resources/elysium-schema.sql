...
alter table TraitChangeStatus drop foreign key TraitChange_TraitChangeStatus_FK;
...
drop table if exists TraitChangeStatus;
...
create table TraitChangeStatus (traitChange_id varchar(255) not null, changedOn datetime, status integer);
create table TraitChange_focuses (TraitChange_id varchar(255) not null, focuses varchar(255));
create table TraitChanges (trait_change_type varchar(31) not null, id varchar(255) not null, ordinal integer, rating integer, specialization varchar(255), child_id varchar(255), primary key (id));
...
alter table TraitChangeStatus add constraint TraitChange_TraitChangeStatus_FK foreign key (traitChange_id) references TraitChanges (id);
