...
alter table PlayerCharacter_Status drop foreign key Status_PlayerCharacter_FK;
alter table PlayerCharacter_Status drop foreign key PlayerCharacter_Status_FK;
...
drop table if exists ApplicableStatus;
...
drop table if exists PlayerCharacter_Status;
...
create table ApplicableStatus (id varchar(255) not null, specialization varchar(255), trait integer, primary key (id));
...
create table PlayerCharacter_Status (PlayerCharacter_id varchar(255) not null, status_id varchar(255) not null, primary key (PlayerCharacter_id, status_id));
...
alter table PlayerCharacter_Status add constraint PlayerCharacter_Status_UC  unique (status_id);
...
alter table PlayerCharacter_Status add constraint Status_PlayerCharacter_FK foreign key (status_id) references Status (id);
alter table PlayerCharacter_Status add constraint PlayerCharacter_Status_FK foreign key (PlayerCharacter_id) references PlayerCharacter (id);
