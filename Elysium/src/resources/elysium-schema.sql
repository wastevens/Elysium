...
create table TraitChanges (trait_change_type varchar(31) not null, id varchar(255) not null, status integer, rating integer, trait_ordinal integer, specialization varchar(255), factory integer, ordinal integer, typeIdentifier varchar(255), child_id varchar(255), traitToRemove_id varchar(255), trait_id varchar(255), primary key (id));
