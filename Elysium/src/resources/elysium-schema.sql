...
create table CharacterBackgrounds (id varchar(255) not null, rating integer, specialization varchar(255), background integer, character_id varchar(255), primary key (id));
create table CharacterDisciplines (character_id varchar(255) not null, rating integer not null, trait integer not null, primary key (character_id, rating, trait));
...
create table CharacterNecromanticPaths (character_id varchar(255) not null, power integer not null, rating integer not null, primary key (character_id, power, rating));
create table CharacterSkillFocuses (CharacterSkill_id varchar(255) not null, focus varchar(255));
create table CharacterSkills (id varchar(255) not null, rating integer, specialization varchar(255), skill integer, character_id varchar(255), primary key (id));
create table CharacterTechniques (PlayerCharacter_id varchar(255) not null, technique integer);
create table CharacterThamaturgicalPaths (character_id varchar(255) not null, rating integer not null, trait integer not null, primary key (character_id, rating, trait));
