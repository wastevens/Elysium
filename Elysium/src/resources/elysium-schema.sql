...
create table PlayerCharacter_AppliedTraitChanges (PlayerCharacter_id integer not null, appliedTraitChanges_id integer not null, order_by integer not null, primary key (PlayerCharacter_id, order_by));
create table PlayerCharacter_ExperienceAward (PlayerCharacter_id integer not null, experienceAwards_id integer not null);
create table PlayerCharacter_RequestedTraitChanges (PlayerCharacter_id integer not null, requesedTraitChanges_id integer not null, order_by integer not null, primary key (PlayerCharacter_id, order_by));
...
create table TraitChange_focuses (TraitChange_id integer not null, focuses varchar(255));
create table TraitChanges (id integer not null, cost integer, rating integer, specialization varchar(255), remove bit, traitOrdinal integer, traitTypeOrdinal integer, child_id integer, primary key (id));
...
create table ID_Sequences ( sequence_name varchar(255),  sequence_next_hi_value integer );
