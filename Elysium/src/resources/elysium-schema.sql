alter table BackgroundChangeFocuses drop foreign key FK_m0kl25ihw6g1tl84k60g76e0q;
...
alter table SkillChangeFocuses drop foreign key FK_cmqla55h3eqbgvjnugcl2iv0x;
...
drop table if exists BackgroundChangeFocuses;
...
drop table if exists SkillChangeFocuses;
...
create table BackgroundChangeFocuses (SetBackgroundEvent_id varchar(255) not null, focus varchar(255));
...
create table SkillChangeFocuses (SetSkillEvent_id varchar(255) not null, focus varchar(255));
...
create table TraitChanges (trait_change_type varchar(31) not null, id varchar(255) not null, character_id varchar(255), status integer, rating integer, ordinal integer, specialization varchar(255), order_by integer, primary key (id));
...
alter table BackgroundChangeFocuses add constraint FK_m0kl25ihw6g1tl84k60g76e0q foreign key (SetBackgroundEvent_id) references TraitChanges (id);
...
alter table SkillChangeFocuses add constraint FK_cmqla55h3eqbgvjnugcl2iv0x foreign key (SetSkillEvent_id) references TraitChanges (id);
