...
alter table CharacterThamaturgy drop foreign key FK_5vohxwp625x4l3adtgkk9nluf;
...
drop table if exists CharacterThamaturgy;
...
create table CharacterThamaturgy (character_id varchar(255) not null, path integer, rating integer not null, primary key (character_id, rating));
...
create table PlayerCharacter (id varchar(255) not null, deleted_at datetime, name varchar(255), primaryThaumaturgicalPath integer, primary key (id));
...
alter table CharacterThamaturgy add constraint FK_5vohxwp625x4l3adtgkk9nluf foreign key (character_id) references PlayerCharacter (id);
