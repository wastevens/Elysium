...
alter table Player_PlayerCharacter drop foreign key FK_7oe25ghqs8m6kuvtcs3pohrxf;
alter table Player_PlayerCharacter drop foreign key FK_eli7nrvuc60id0m2bdpmdiwvm;
...
alter table Troupe_Player drop foreign key FK_223p5s447c4gog7158w8vegbl;
alter table Troupe_Player drop foreign key FK_r25656bsr2enaynnwuaxe7jlo;
alter table Troupe_PlayerCharacter drop foreign key FK_lrxwmgade6p8qaxtvpwp9u42u;
alter table Troupe_PlayerCharacter drop foreign key FK_t53j8gwct8nocnk9kos2aojux;
...
drop table if exists Troupe_Player;
drop table if exists Troupe_PlayerCharacter;
...
create table Troupe_Player (troupes_id varchar(255) not null, players_id varchar(255) not null, primary key (troupes_id, players_id));
create table Troupe_PlayerCharacter (Troupe_id varchar(255) not null, characters_id varchar(255) not null, primary key (Troupe_id, characters_id));
alter table Player_PlayerCharacter add constraint UK_7oe25ghqs8m6kuvtcs3pohrxf  unique (characters_id);
alter table Troupe_PlayerCharacter add constraint UK_lrxwmgade6p8qaxtvpwp9u42u  unique (characters_id);
...
alter table Player_PlayerCharacter add constraint FK_7oe25ghqs8m6kuvtcs3pohrxf foreign key (characters_id) references PlayerCharacter (id);
alter table Player_PlayerCharacter add constraint FK_eli7nrvuc60id0m2bdpmdiwvm foreign key (Player_id) references Player (id);
...
alter table Troupe_Player add constraint FK_223p5s447c4gog7158w8vegbl foreign key (players_id) references Player (id);
alter table Troupe_Player add constraint FK_r25656bsr2enaynnwuaxe7jlo foreign key (troupes_id) references Troupe (id);
alter table Troupe_PlayerCharacter add constraint FK_lrxwmgade6p8qaxtvpwp9u42u foreign key (characters_id) references PlayerCharacter (id);
alter table Troupe_PlayerCharacter add constraint FK_t53j8gwct8nocnk9kos2aojux foreign key (Troupe_id) references Troupe (id);
