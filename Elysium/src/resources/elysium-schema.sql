...
create table CharacterThamaturgicalRituals (PlayerCharacter_id varchar(255) not null, thaumaturgical_ritual integer);
...
create table PlayerCharacter (id varchar(255) not null, deleted_at datetime, name varchar(255), primary_thaumaturgical_path integer, primary key (id));
