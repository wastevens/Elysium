...
create table TraitChanges (trait_change_type varchar(31) not null, id varchar(255) not null, character_id varchar(255), status integer, ordinal integer, rating integer, specialization varchar(255), order_by integer, primary key (id));
