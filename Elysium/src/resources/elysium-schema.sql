...
alter table PlayerCharacter_ElderPowers drop foreign key ElderPowers_PlayerCharacter_FK;
...
alter table PlayerCharacter_Techniques drop foreign key Techniques_PlayerCharacter_FK;
...
drop table if exists ElderPowers;
...
create table ElderPowers (id varchar(255) not null, trait integer not null, primary key (id));
...
create table PlayerCharacter_ElderPowers (PlayerCharacter_id varchar(255) not null, elderPowers_id varchar(255) not null, primary key (PlayerCharacter_id, elderPowers_id));
...
create table PlayerCharacter_Techniques (PlayerCharacter_id varchar(255) not null, techniques_id varchar(255) not null, primary key (PlayerCharacter_id, techniques_id));
...
create table Techniques (id varchar(255) not null, trait integer not null, primary key (id));
create table ThaumaturgicalPaths (id varchar(255) not null, rating integer, trait integer not null, primary key (id));
create table TraitChanges (trait_change_type varchar(31) not null, id varchar(255) not null, status integer, factory integer, ordinal integer, specialization varchar(255), typeIdentifier varchar(255), rating integer, child_id varchar(255), traitToRemove_id varchar(255), trait_id varchar(255), primary key (id));
...
alter table PlayerCharacter_ElderPowers add constraint PlayerCharacter_ElderPowers_UC  unique (elderPowers_id);
...
alter table PlayerCharacter_Techniques add constraint PlayerCharacter_Techniques_UC  unique (techniques_id);
...
alter table PlayerCharacter_ElderPowers add constraint ElderPowers_PlayerCharacter_FK foreign key (elderPowers_id) references ElderPowers (id);
...
alter table PlayerCharacter_Techniques add constraint Techniques_PlayerCharacter_FK foreign key (techniques_id) references Techniques (id);
