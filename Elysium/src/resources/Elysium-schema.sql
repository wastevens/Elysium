...
create table AttributeValue (attribute_type varchar(31) not null, id bigint not null, value integer, primary key (id));
create table Backgrounds (id bigint not null, rating integer, specialization varchar(255), background integer, character_id bigint, primary key (id));
create table Backgrounds_Focuses (CharacterBackground_id bigint not null, focuses varchar(255));
create table Disciplines (id bigint not null, rating integer, trait integer not null, character_id bigint, primary key (id));
create table ExperienceAward (id bigint not null, awardedFor varchar(255), awardedOn datetime, experience integer, primary key (id));
create table Flaws (id bigint not null, specialization varchar(255), trait integer not null, character_id bigint, primary key (id));
create table Merits (id bigint not null, specialization varchar(255), trait integer not null, character_id bigint, primary key (id));
create table PlayerCharacter (id bigint not null, approvalStatus integer, awardedXp integer, baseXp integer, bloodline integer, clan integer, groundXp integer, mental_attribute integer, name varchar(255), physical_attribute integer, primary_necromantic_path integer, primary_thaumaturgical_path integer, setting integer, social_attribute integer, appliedSpentXp integer, pendingSpentXp integer, primary key (id));
create table PlayerCharacter_AppliedTraitChanges (PlayerCharacter_id bigint not null, appliedTraitChanges_id bigint not null, order_by integer not null, primary key (PlayerCharacter_id, order_by));
create table PlayerCharacter_ExperienceAward (PlayerCharacter_id bigint not null, experienceAwards_id bigint not null);
create table PlayerCharacter_RequestedTraitChanges (PlayerCharacter_id bigint not null, requesedTraitChanges_id bigint not null, order_by integer not null, primary key (PlayerCharacter_id, order_by));
create table PlayerCharacter_elderPowers (PlayerCharacter_id bigint not null, elderPowers integer);
create table PlayerCharacter_inClanDisciplines (PlayerCharacter_id bigint not null, inClanDisciplines integer, order_by integer not null, primary key (PlayerCharacter_id, order_by));
create table PlayerCharacter_mentalAttrbuteFocuses (PlayerCharacter_id bigint not null, mentalAttrbuteFocuses integer);
create table PlayerCharacter_necromanticRituals (PlayerCharacter_id bigint not null, necromanticRituals integer);
create table PlayerCharacter_physicalAttributeFocuses (PlayerCharacter_id bigint not null, physicalAttributeFocuses integer);
create table PlayerCharacter_playerStatusChanges (PlayerCharacter_id bigint not null, changedOn datetime, status integer, order_by integer not null, primary key (PlayerCharacter_id, order_by));
create table PlayerCharacter_socialAttributeFocuses (PlayerCharacter_id bigint not null, socialAttributeFocuses integer);
create table PlayerCharacter_techniques (PlayerCharacter_id bigint not null, techniques integer);
create table PlayerCharacter_thaumaturgicalRituals (PlayerCharacter_id bigint not null, thaumaturgicalRituals integer);
create table Skills (id bigint not null, rating integer, specialization varchar(255), skill integer, character_id bigint, primary key (id));
create table Skills_Focuses (CharacterSkill_id bigint not null, focuses varchar(255));
create table Status (id bigint not null, specialization varchar(255), trait integer not null, character_id bigint, primary key (id));
